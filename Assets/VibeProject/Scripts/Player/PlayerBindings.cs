...
//     version 1.18.0
//     from Assets/VibeProject/Scripts/Player/PlayerBindings.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/VibeProject/Scripts/Player/PlayerBindings.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerBindings: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerBindings()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerBindings.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, PlayerBindings.UI.Disable() has not been called.");
    }
